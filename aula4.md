...
Durante o intervalo da aula, Ana pergunta a um professor sobre projetos, ligas acadêmicas e eventos. O professor menciona algumas iniciativas que conhece, mas demonstra incerteza quanto à continuidade de algumas delas e sugere que ela procure o centro acadêmico. Ao perceber que a resposta é parcial e pouco específica, Ana conclui que depender apenas da orientação dos professores não será suficiente para obter uma visão completa das oportunidades disponíveis.

Ao chegar em casa, decide executar a segunda etapa do plano. Pesquisa o Instagram oficial da universidade e de alguns grupos estudantis. Encontra postagens antigas misturadas com novas, divulgações sem datas claras e links que não funcionam mais. Diante desse cenário, Ana sente insegurança sobre quais eventos ainda estão ativos e começa a perceber que as redes sociais não oferecem uma organização cronológica ou categorizada das atividades.

No dia seguinte, uma colega adiciona Ana em um grupo de WhatsApp da turma. Entre mensagens sobre provas, trabalhos e conversas paralelas, aparecem divulgações de eventos e projetos. No entanto, as informações são rapidamente soterradas por novas mensagens. Ao tentar localizar novamente um anúncio que havia visto anteriormente, Ana não consegue encontrá-lo com facilidade. Ela então percebe que aquele canal não foi estruturado para centralizar informações acadêmicas, mas para comunicação informal entre os alunos.

Ainda determinada a encontrar uma fonte mais confiável, Ana acessa o site institucional da universidade. Navega por diferentes menus até localizar uma seção sobre atividades extracurriculares. Entretanto, encontra descrições genéricas, algumas páginas desatualizadas e poucos detalhes sobre como se inscrever. Ao comparar as informações do site com aquelas vistas nas redes sociais, nota divergências e sente dificuldade para entender qual conteúdo está correto.
...
Na primeira semana de aula, Ana Beatriz Cavalcante, 18 anos, caloura do curso de Administração, chega à universidade com grandes expectativas. Ela deseja fazer novos amigos, participar de atividades extracurriculares e começar desde cedo a construir um currículo diferenciado. [Q3] Ela acredita que participar dessas atividades pode ajudá-la a desenvolver habilidades práticas, ampliar sua rede de contatos e fortalecer seu currículo para oportunidades futuras.

Acostumada a encontrar informações rapidamente em redes sociais e aplicativos, acredita que conseguirá descobrir facilmente as oportunidades disponíveis no ambiente acadêmico.

Ao perceber que, durante a recepção de calouros, não recebeu orientações claras sobre onde encontrar atividades extracurriculares, Ana começa a refletir sobre como poderia obter essas informações. [Q6] A ausência dessas orientações faz com que ela perceba que precisará buscar essas informações por conta própria.

Mentalmente, organiza um plano: primeiro perguntaria aos professores do curso, depois buscaria informações nas redes sociais da faculdade e, se necessário, entraria em grupos estudantis para complementar o que encontrasse. [Q4] Ela acredita que, seguindo essas etapas, conseguirá reunir uma visão geral das atividades disponíveis na universidade.

Durante o intervalo da aula, Ana pergunta a um professor sobre projetos, ligas acadêmicas e eventos. O professor menciona algumas iniciativas que conhece, mas demonstra incerteza quanto à continuidade de algumas delas e sugere que ela procure o centro acadêmico. [Q2] Nesse momento, Ana percebe que as informações dependem de diferentes pessoas dentro da universidade, como professores, alunos veteranos e representantes de entidades estudantis.

Ao perceber que a resposta é parcial e pouco específica, Ana conclui que depender apenas da orientação dos professores não será suficiente para obter uma visão completa das oportunidades disponíveis.

Ao chegar em casa, decide executar a segunda etapa do plano. Pesquisa o Instagram oficial da universidade e de alguns grupos estudantis. [Q1] Ela realiza essa busca utilizando principalmente seu celular e seu notebook, alternando entre diferentes aplicativos e páginas da internet.

Encontra postagens antigas misturadas com novas, divulgações sem datas claras e links que não funcionam mais. Diante desse cenário, Ana sente insegurança sobre quais eventos ainda estão ativos e começa a perceber que as redes sociais não oferecem uma organização clara das atividades. [Q5] Para tentar entender quais informações ainda são válidas, ela precisa comparar diferentes postagens e verificar manualmente as datas das publicações.

No dia seguinte, uma colega adiciona Ana em um grupo de WhatsApp da turma. Entre mensagens sobre provas, trabalhos e conversas paralelas, aparecem divulgações de eventos e projetos. No entanto, as informações são rapidamente soterradas por novas mensagens. Ao tentar localizar novamente um anúncio que havia visto anteriormente, Ana não consegue encontrá-lo com facilidade.
...
Lucas, 24 anos, está em seu último ano da graduação na área de tecnologia. Estagiário em uma empresa do setor, divide sua rotina entre o trabalho, as aulas presenciais, atividades acadêmicas e o desenvolvimento do Trabalho de Conclusão de Curso (TCC). [Q1] Por causa dessa rotina intensa, Lucas costuma acessar informações acadêmicas principalmente pelo celular durante pequenos intervalos entre suas atividades.

Com a aproximação do prazo para definir o tema do TCC, Lucas começa a se sentir pressionado. Ele tem algumas ideias iniciais, mas não tem certeza se são relevantes, viáveis ou suficientemente inovadoras. [Q3] Ele sabe que a escolha de um bom tema é importante para sua avaliação final e também pode influenciar oportunidades profissionais futuras.

Diante disso, Lucas organiza mentalmente um plano: ao final das aulas, conversaria com alguns colegas próximos para ouvir opiniões e, posteriormente, procuraria professores para discutir a viabilidade técnica das propostas. [Q4] Lucas acredita que ouvir diferentes opiniões pode ajudá-lo a amadurecer melhor suas ideias antes de formalizar a escolha do tema.

Nos dias seguintes, coloca o plano em prática. Durante intervalos rápidos entre uma aula e outra, comenta suas ideias com amigos. Alguns demonstram interesse, outros sugerem pequenas melhorias, mas as conversas são breves e superficiais, pois todos também estão com pressa. [Q5] Essas conversas acontecem rapidamente nos corredores ou ao final das aulas, sem muito tempo para discussões mais aprofundadas.

Em seguida, procura dois professores para discutir suas propostas. Consegue conversar rapidamente com um deles após a aula, mas o tempo é curto e o professor sugere que ele refine melhor a ideia antes de aprofundar a discussão. [Q2] Lucas percebe que a validação do tema depende não apenas da opinião dos professores, mas também da troca de ideias com outros estudantes e pessoas com experiência na área.

Ao longo das semanas, Lucas percebe que, com sua rotina corrida, torna-se difícil ampliar seu círculo de diálogo. Não participa de muitos eventos e raramente permanece no campus além do horário das aulas. [Q6] A proximidade do prazo para definir o tema do TCC aumenta ainda mais sua necessidade de validar suas ideias rapidamente.

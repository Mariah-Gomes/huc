...
### Legenda usada
- `>>` = habilitação / em seguida
- `[]` = escolha entre alternativas
- `|=|` = tarefas independentes / podem ocorrer em momentos diferentes
- `*` = repetição opcional
...
Acompanhar conteúdo =
[
  Navegar pelo feed rolando a tela
  []
  Filtrar conteúdo por tags
  []
  Buscar conteúdo pelo campo de busca
]

Navegar pelo feed rolando a tela =
visualizar tela inicial do feed
>> identificar publicações exibidas
>> rolar a tela para visualizar mais conteúdos
>>*

Filtrar conteúdo por tags =
visualizar tela inicial do feed
>> clicar no botão Filtrar
>> buscar e selecionar tag(s) desejada(s)
>> clicar em Aplicar
>> visualizar feed filtrado

Buscar conteúdo pelo campo de busca =
visualizar tela inicial do feed
>> clicar no campo de busca
>> escrever palavras-chave
>> visualizar feed com resultados da busca
...
[
  ...
  []
  Denunciar publicações
]

Reagir a publicações =
visualizar publicação desejada
>> identificar botão de reação
>> clicar na reação desejada
>> visualizar reação aplicada

Comentar publicações =
visualizar publicação desejada
>> identificar opção de comentar
>> clicar na opção de comentar
>> visualizar campo de comentário
>> escrever comentário
>> enviar comentário
>> visualizar comentário publicado

Denunciar publicações =
visualizar publicação desejada
>> identificar menu de opções
>> clicar no menu de opções
>> selecionar opção Denunciar
>> visualizar tela de denúncia
...
Publicar conteúdo =
visualizar tela inicial do feed
>> identificar botão de criar publicação
>> clicar no botão de criar publicação
>> visualizar tela de criação de publicação
>> preencher campos obrigatórios
>> clicar em Publicar
>> visualizar publicação criada no feed

#### Goal 2.2: Editar conteúdo

Editar conteúdo =
visualizar publicação de sua autoria
>> identificar menu de opções
>> clicar no menu de opções
>> selecionar opção Editar
>> visualizar tela de edição
>> alterar conteúdo desejado
>> salvar alterações
>> visualizar publicação atualizada
...
>> confirmar exclusão
>> visualizar feed sem a publicação excluída

...
<table>
  <tr>
    <td valign="top">
      <img width="500" height="250" alt="Persona Ana Beatriz" src="../assets/aula3/ana.png" />
    </td>
    <td valign="top">
...
| Revisar conteúdo             | Diária     | Alta        | 1–2h     |
| Trabalhos em grupo           | Semanal    | Alta        | Variável |
...
| Tirar dúvida sobre disciplina | Semanal    | Entender conteúdo   |
| Ver eventos universitários    | Semanal    | Socializar          |
...
<table>
  <tr>
    <td valign="top">
      <img width="500" height="250" alt="Persona Lucas Silva" src="../assets/aula3/lucas.png" />
    </td>
    <td valign="top">
      ...
      <strong>Situação profissional:</strong> Estagiário em empresa de tecnologia<br>
      <strong>Tempo de deslocamento diário:</strong> Aproximadamente 2 horas<br>
      <strong>Status:</strong> Persona Primária - Representa estudantes veteranos que conciliam trabalho e graduação, com foco em eficiência, produtividade, troca de conhecimento, desenvolvimento acadêmico e consolidação profissional<br>
...
| Assistir aulas      | 5x por semana | Alta        | 3–5h    |
| Deslocamento        | Diária        | Alta        | 2h      |
...
| Buscar referências para TCC         | Semanal    | Produção acadêmica                 |
| Aplicar questionários na comunidade | Pontual    | Coleta de dados                    |
...
- Segmentação por curso/disciplina
- Espaço para divulgação de pesquisas acadêmicas
...
- Conecte alunos da área de tecnologia
...
## Perfil 3 — Professor Universitário
...
<table>
  <tr>
    <td valign="top">
      <img width="500" height="250" alt="Persona Professor Rafael Almeida" src="../assets/aula3/professor.png" />
    </td>
    <td valign="top">
      <strong>Nome:</strong> Rafael Almeida Martins<br>
      <strong>Idade:</strong> 42 anos<br>
      <strong>Área de atuação:</strong> Docente universitário na área de tecnologia e projetos acadêmicos<br>
      <strong>Modalidade:</strong> Presencial<br>
      <strong>Estado civil:</strong> Casado<br>
      <strong>Renda familiar:</strong> Classe média<br>
      <strong>Situação profissional:</strong> Professor universitário e orientador de trabalhos acadêmicos<br>
      <strong>Tempo de atuação docente:</strong> Aproximadamente 12 anos<br>
      <strong>Status:</strong> Persona Secundária - Representa professores que desejam se aproximar dos estudantes, acompanhar dúvidas recorrentes e compartilhar conteúdos acadêmicos de forma complementar aos canais institucionais formais<br>
      <strong>Justificativa:</strong> Professores fazem parte do ecossistema universitário e podem contribuir para a qualidade das discussões acadêmicas. Embora o foco principal da plataforma esteja nos estudantes, docentes podem utilizar a rede como um espaço complementar para orientar, divulgar materiais, identificar dificuldades comuns e estimular a participação dos alunos em atividades acadêmicas.<br>
    </td>
  </tr>
</table>
...
| Acadêmicos                                        | Sociais                             | Profissionais                                  |
| ------------------------------------------------- | ----------------------------------- | ---------------------------------------------- |
| - Compartilhar conteúdos complementares           | - Aproximar-se dos alunos           | - Fortalecer sua atuação como docente          |
| - Acompanhar dúvidas recorrentes das turmas       | - Incentivar participação acadêmica | - Divulgar projetos, pesquisas e oportunidades |
| - Orientar discussões relacionadas às disciplinas | - Estimular troca entre estudantes  | - Ampliar impacto de suas ações acadêmicas     |

### Dores e Frustrações

- Dificuldade em acompanhar dúvidas que circulam apenas em grupos informais
- Baixa participação dos alunos em canais institucionais formais
- Falta de visibilidade sobre dificuldades recorrentes das turmas
- Comunicação fragmentada entre alunos, professores e projetos acadêmicos
- Dificuldade em divulgar materiais, eventos e oportunidades de forma centralizada

### Habilidades

- Experiência em orientação acadêmica
- Boa comunicação didática
- Familiaridade com ferramentas digitais institucionais
- Capacidade de organizar conteúdos e orientar discussões
- Conhecimento sobre necessidades acadêmicas dos estudantes

### Tarefas

| Tarefa                        | Frequência | Importância | Duração  |
| ----------------------------- | ---------- | ----------- | -------- |
| Ministrar aulas               | Semanal    | Muito Alta  | 3–8h     |
| Preparar materiais            | Semanal    | Alta        | 2–4h     |
| Orientar trabalhos acadêmicos | Semanal    | Alta        | Variável |
| Responder dúvidas de alunos   | Semanal    | Alta        | Variável |
| Divulgar eventos e projetos   | Mensal     | Média       | 1–2h     |

### Tarefas Relacionadas à Plataforma

| Situação                               | Frequência | Objetivo                                     |
| -------------------------------------- | ---------- | -------------------------------------------- |
| Compartilhar material complementar     | Semanal    | Apoiar o aprendizado dos estudantes          |
| Acompanhar dúvidas recorrentes         | Semanal    | Identificar dificuldades comuns              |
| Responder ou orientar discussões       | Ocasional  | Melhorar a qualidade da troca acadêmica      |
| Divulgar eventos e oportunidades       | Mensal     | Ampliar a participação dos alunos            |
| Observar temas de interesse dos alunos | Ocasional  | Adaptar exemplos e conteúdos às necessidades |

### Relacionamentos

- Estudantes das disciplinas
- Orientandos de TCC
- Outros professores
...
- Ambiente organizado por temas, cursos ou interesses
- Possibilidade de compartilhar materiais e links
- Visualização de dúvidas e discussões acadêmicas
- Interação simples com estudantes
- Moderação e respeito nas discussões
- Separação clara entre comunicação informal e canais institucionais formais

### Expectativas

Rafael espera que a plataforma:

- Facilite a aproximação com os alunos
- Ajude a identificar dúvidas recorrentes
- Permita compartilhar conteúdos complementares
- Estimule discussões acadêmicas mais participativas
- Seja um ambiente respeitoso, organizado e útil
- Complemente, sem substituir, os sistemas institucionais formais

### Comportamento Digital

- Usa computador como principal meio de acesso
- Utiliza celular para consultas rápidas
- Prefere interações objetivas e organizadas
- Valoriza clareza, respeito e relevância nas discussões
- Participa quando percebe que sua contribuição pode orientar ou enriquecer o aprendizado

## Diferença estratégica entre as duas personas primárias

| Ana (Ingressante)     | Lucas (Veterano Trabalhador) |
| --------------------- | ---------------------------- |
| Busca pertencimento   | Busca eficiência             |
| Precisa de integração | Precisa de otimização        |
| Interação social      | Interação estratégica        |
...
## Mapa de Empatia de Rafael Almeida Martins

> Mapa construído a partir de simulação de entrevista semiestruturada com professor universitário que utiliza ferramentas digitais para apoiar a comunicação com estudantes e o compartilhamento de conteúdos acadêmicos.

<table>
  <tr>
    <td valign="top" width="50%">
      <strong>👀 O que Rafael vê?</strong><br><br>
      - Estudantes com dúvidas semelhantes espalhadas em diferentes canais<br>
      - Baixa participação em ambientes institucionais formais<br>
      - Alunos buscando respostas em grupos informais e redes sociais<br>
      - Dificuldade dos estudantes em encontrar referências confiáveis<br>
      - Oportunidades acadêmicas com pouca visibilidade entre os alunos<br>
      - Turmas com diferentes níveis de engajamento<br><br>
      <strong>📌 Contexto:</strong><br>
      Rafael percebe que a universidade possui muitos canais e oportunidades, mas a comunicação acadêmica entre alunos e professores ainda é fragmentada.
    </td>
    <td valign="top" width="50%">
      <strong>👂 O que Rafael ouve?</strong><br><br>
      - “Professor, ninguém viu esse aviso.”<br>
      - “Essa dúvida já apareceu no grupo da turma.”<br>
      - “Tem algum material extra para estudar?”<br>
      - “Onde posso divulgar meu questionário?”<br>
      - “Não sabia que tinha esse projeto.”<br><br>
      <strong>📌 Influência:</strong><br>
      As falas dos alunos mostram que muitas informações acadêmicas importantes não chegam a todos de forma clara ou centralizada.
    </td>
  </tr>
  <tr>
    <td valign="top" width="50%">
      <strong>🗣 O que Rafael diz e faz?</strong><br><br>
      <strong>O que ele diz:</strong><br>
      - “Seria bom ter um espaço mais informal para apoiar os alunos.”<br>
      - “Muitos têm a mesma dúvida, mas perguntam em lugares diferentes.”<br>
      - “Quero compartilhar materiais sem depender apenas do ambiente institucional.”<br>
      - “As discussões entre alunos também ajudam no aprendizado.”<br><br>
      <strong>O que ele faz:</strong><br>
      - Compartilha materiais complementares<br>
      - Responde dúvidas recorrentes<br>
      - Orienta alunos em trabalhos e projetos<br>
      - Divulga eventos, pesquisas e oportunidades<br>
      - Observa dificuldades comuns para ajustar explicações futuras<br><br>
      <strong>📌 Comportamento:</strong><br>
      Rafael atua como facilitador do aprendizado, buscando ampliar o alcance da comunicação acadêmica sem transformar a rede social em um ambiente formal de aula.
    </td>
    <td valign="top" width="50%">
      <strong>💭 O que Rafael pensa e sente?</strong><br><br>
      <strong>Pensamentos:</strong><br>
      - “Como posso me aproximar mais dos alunos?”<br>
      - “Como identificar dúvidas recorrentes sem depender de vários grupos?”<br>
      - “Quero incentivar participação, mas sem sobrecarregar a turma.”<br>
      - “A tecnologia pode apoiar a aprendizagem se for bem organizada.”<br><br>
      <strong>Sentimentos:</strong><br>
      - Responsabilidade com a aprendizagem<br>
      - Preocupação com alunos pouco participativos<br>
      - Interesse em inovação educacional<br>
      - Frustração com a dispersão de informações<br>
      - Motivação para orientar e apoiar os estudantes<br><br>
      <strong>Expectativas sobre a rede social:</strong><br>
      - Ambiente respeitoso<br>
      - Comunicação acadêmica mais próxima<br>
      - Espaço para materiais complementares<br>
      - Discussões organizadas por temas<br>
...
<table>
  <tr>
    <td valign="top" width="50%">
      <strong>😰 Dores</strong><br><br>
      - Dificuldade em acompanhar dúvidas espalhadas em múltiplos canais<br>
      - Pouca visibilidade sobre dificuldades recorrentes dos estudantes<br>
      - Baixa adesão a ambientes institucionais formais<br>
      - Comunicação acadêmica fragmentada<br>
      - Dificuldade em divulgar conteúdos e oportunidades para todos os alunos interessados<br><br>
      <strong>📌 Dor central:</strong><br>
      Falta de um ambiente complementar e organizado para aproximar professores e estudantes na troca de conhecimentos acadêmicos.
    </td>
    <td valign="top" width="50%">
      <strong>🎁 Ganhos</strong><br><br>
      - Maior proximidade com os estudantes<br>
      - Identificação de dúvidas recorrentes<br>
      - Divulgação mais ampla de materiais e oportunidades<br>
      - Discussões acadêmicas mais participativas<br>
      - Apoio ao aprendizado fora do momento formal da aula<br>
      - Fortalecimento da comunidade acadêmica<br><br>
      <strong>📌 Ganho principal:</strong><br>
      Aproximação + orientação + compartilhamento de conhecimento.
    </td>
  </tr>
</table>
...
&nbsp;&nbsp;&nbsp;&nbsp;Rafael não busca substituir os canais institucionais formais.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Ele busca:<br>
...
- Comunicação mais acessível<br>
  &nbsp;&nbsp;&nbsp;&nbsp;A plataforma deve permitir que professores participem como apoiadores da comunidade acadêmica, sem deslocar o foco principal da experiência dos estudantes.
...
- Transporte público
- Intervalos no trabalho (para estudantes trabalhadores)
...
A plataforma é utilizada de forma complementar aos sistemas institucionais formais, com foco em interação social-acadêmica, centralização da troca de conhecimentos e aproximação entre participantes da comunidade universitária.
...
- Comunicação predominantemente informal entre alunos
...
Para professores, o contexto social envolve:

- Aproximação com estudantes
- Acompanhamento de dúvidas recorrentes
- Compartilhamento de conteúdos complementares
- Participação em discussões acadêmicas de forma orientadora

A rede social acadêmica atua como mediadora digital dessas interações, promovendo conexão entre diferentes perfis dentro da instituição. Apesar disso, o foco principal da experiência continua sendo a interação entre estudantes, enquanto professores aparecem como participantes complementares do ecossistema acadêmico.
...
- Compartilhamento constante de experiências acadêmicas
...
- Áreas de interesse
- Área de atuação ou disciplinas relacionadas
- Participação em projetos ou TCC
...
- Está revisando conteúdo
- Está buscando referências para o TCC
...
- Oferecer segmentação clara
- Reduzir ruído informacional
- Adaptar-se a diferentes níveis de engajamento

## Síntese Geral do Contexto de Uso

&nbsp;&nbsp;&nbsp;&nbsp;A rede social acadêmica será utilizada em um ambiente universitário dinâmico, socialmente diverso e digitalmente conectado, principalmente por estudantes em diferentes estágios da graduação — desde ingressantes em busca de integração até veteranos trabalhadores focados em produtividade, troca de conhecimento e desenvolvimento do TCC.<br>
&nbsp;&nbsp;&nbsp;&nbsp;A aplicação atua como espaço complementar aos sistemas institucionais formais, promovendo interação social-acadêmica, centralização da troca de conhecimento, networking e apoio à produção acadêmica, principalmente por meio de dispositivos móveis e em contextos de uso fragmentado ao longo da rotina universitária.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Professores também podem participar como usuários secundários, contribuindo com orientações, materiais complementares e acompanhamento de dúvidas recorrentes, sem que isso substitua os canais formais da instituição ou desloque o foco principal da experiência dos estudantes.<br>

# Jornadas dos Usuários

## Jornada de Ana Beatriz Cavalcante (Ingressante)

&nbsp;&nbsp;&nbsp;&nbsp;Ana está no início da faculdade e ainda se sente deslocada. Apesar de frequentar as aulas diariamente, ela percebe que os colegas já começam a formar grupos e sente dificuldade em se aproximar. Além disso, percebe que muitas informações acadêmicas circulam em grupos informais, redes sociais e conversas paralelas, o que dificulta acompanhar tudo o que acontece no ambiente universitário. Tem receio de parecer desinformada e acaba participando pouco das conversas. <br>
&nbsp;&nbsp;&nbsp;&nbsp;Um dia, ouve colegas comentando sobre uma rede social acadêmica da instituição. Curiosa e buscando uma forma menos intimidadora de se aproximar das pessoas e encontrar informações acadêmicas mais organizadas, decide se cadastrar. <br>
&nbsp;&nbsp;&nbsp;&nbsp;Nos primeiros dias, apenas observa as interações. Vê alunos comentando sobre disciplinas, compartilhando experiências, tirando dúvidas e divulgando eventos. Em uma dessas publicações, descobre que haverá uma festa organizada por alunos do seu curso. <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;Nas semanas seguintes, começa a interagir mais tanto presencialmente quanto na rede. Participa de um grupo de estudo que conheceu por meio da plataforma, acompanha discussões acadêmicas relacionadas às suas disciplinas e passa a se sentir parte da universidade. <br>
&nbsp;&nbsp;&nbsp;&nbsp;No final do semestre, Ana percebe que:

- Construiu novas amizades
- Participou de eventos que antes nem saberia que existiam
- Encontrou um espaço mais organizado para acompanhar informações acadêmicas
...
&nbsp;&nbsp;&nbsp;&nbsp;Lucas está no sétimo semestre e conciliando trabalho e faculdade. Com o início do TCC, sente pressão para definir metodologia e coletar dados suficientes. Ele sabe que precisa alcançar muitos estudantes, mas percebe que divulgar sua pesquisa apenas em grupos informais não é suficiente, pois as informações se perdem rapidamente entre mensagens, conversas paralelas e conteúdos não relacionados.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;Além disso, Lucas utiliza filtros e busca por palavras-chave para encontrar discussões técnicas relacionadas ao seu curso, evitando perder tempo em conteúdos pouco relevantes. A plataforma passa a funcionar como um espaço mais organizado para recuperar informações, compartilhar conhecimento e manter contato com pessoas da área.<br>
...
- Encontrou informações acadêmicas de forma mais rápida e organizada

...
Ao perceber que, durante a recepção de calouros, não recebeu orientações claras sobre onde encontrar atividades extracurriculares, Ana começa a refletir sobre como poderia obter essas informações. [Q5] A ausência dessas orientações faz com que ela perceba que precisará buscar essas informações por conta própria.
...
Durante o intervalo da aula, Ana pergunta a um professor sobre projetos, ligas acadêmicas e eventos. O professor menciona algumas iniciativas que conhece, mas demonstra incerteza quanto à continuidade de algumas delas e sugere que ela procure o centro acadêmico. [Q3] Nesse momento, Ana percebe que as informações dependem de diferentes pessoas dentro da universidade, como professores, alunos veteranos e representantes de entidades estudantis.
...
Ao chegar em casa, decide executar a segunda etapa do plano. Pesquisa o Instagram oficial da universidade e de alguns grupos estudantis. [Q2] Ela realiza essa busca utilizando principalmente seu celular e seu notebook, alternando entre diferentes aplicativos e páginas da internet.
...
Lucas, 24 anos, está em seu último ano da graduação na área de tecnologia. Estagiário em uma empresa do setor, divide sua rotina entre o trabalho, as aulas presenciais, atividades acadêmicas e o desenvolvimento do Trabalho de Conclusão de Curso (TCC). [Q2] Por causa dessa rotina intensa, Lucas costuma acessar informações acadêmicas principalmente pelo celular durante pequenos intervalos entre suas atividades.

Com a aproximação do prazo para definir o tema do TCC, Lucas começa a se sentir pressionado. Ele tem algumas ideias iniciais, mas não tem certeza se são relevantes, viáveis ou suficientemente inovadoras. [Q1] Ele sabe que a escolha de um bom tema é importante para sua avaliação final e também pode influenciar oportunidades profissionais futuras.
...
Em seguida, procura dois professores para discutir suas propostas. Consegue conversar rapidamente com um deles após a aula, mas o tempo é curto e o professor sugere que ele refine melhor a ideia antes de aprofundar a discussão. [Q3] Lucas percebe que a validação do tema depende não apenas da opinião dos professores, mas também da troca de ideias com outros estudantes e pessoas com experiência na área.

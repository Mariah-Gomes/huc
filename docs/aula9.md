...
#### Cenário de interação da Ana Beatriz Cavalcante

Na primeira semana de aula, Ana Beatriz Cavalcante, 18 anos, caloura do curso de Administração, chega à universidade com grandes expectativas. Ela deseja fazer novos amigos, participar de atividades extracurriculares e começar desde cedo a construir um currículo diferenciado. Acostumada a encontrar informações rapidamente em redes sociais e aplicativos, **ela acessa o Goriah acreditando que conseguirá visualizar com mais facilidade as oportunidades disponíveis no ambiente acadêmico.**

Ao perceber que, durante a recepção de calouros, não recebeu orientações claras sobre onde encontrar atividades extracurriculares, Ana começa a refletir sobre como poderia obter essas informações. **Em vez de depender apenas de professores, redes sociais e grupos informais, ela entra no Goriah para procurar publicações sobre projetos, eventos e iniciativas universitárias.**

**Ao acessar o feed da plataforma**, Ana **visualiza conteúdos publicados por outros alunos e por perfis ligados ao ambiente universitário**. **O sistema apresenta publicações relacionadas a eventos, projetos, grupos de estudo e experiências acadêmicas**, permitindo que ela acompanhe as informações em um ambiente mais organizado.

Durante a navegação, Ana percebe que deseja encontrar oportunidades mais específicas. **Ela então utiliza a própria plataforma para focar sua busca em conteúdos ligados a eventos e projetos acadêmicos.** **O sistema responde exibindo publicações relacionadas a esse contexto**, reduzindo conteúdos menos relevantes para aquele momento.

**Ao encontrar uma publicação sobre um evento universitário, Ana acessa as informações disponíveis na própria publicação e acompanha os comentários de outros estudantes.** Com isso, ela percebe que outras pessoas estão compartilhando experiências e informações úteis sobre participação em atividades da universidade.

**Depois de encontrar uma oportunidade relevante, Ana interage com a publicação dentro do próprio Goriah**, aproximando-se daquele contexto acadêmico. **O sistema registra sua interação e mantém o conteúdo acessível para consulta posterior**, caso ela queira voltar àquela informação depois.

Ao final da semana, Ana avalia a situação de forma mais ampla. **Ela percebe que, por meio do Goriah, conseguiu localizar informações de maneira mais organizada, centralizada e confiável**, sem depender exclusivamente de canais dispersos como professores, Instagram, WhatsApp e páginas institucionais. **Assim, sua adaptação à universidade se torna mais simples, rápida e motivadora.**

#### Cenário de interação do Lucas Silva Maciel
...
Com a aproximação do prazo para definir o tema do TCC, Lucas começa a se sentir pressionado. Ele tem algumas ideias iniciais, mas não tem certeza se são relevantes, viáveis ou suficientemente inovadoras. Seu objetivo é escolher um tema consistente, com aplicabilidade prática e que seja bem avaliado pela banca.

Diante disso, Lucas organiza mentalmente um plano. **Em vez de depender apenas de conversas rápidas com colegas e professores, ele acessa o Goriah para discutir suas ideias com um grupo mais amplo de pessoas.**

**Ao entrar na plataforma, Lucas acompanha publicações recentes do feed e identifica discussões acadêmicas ligadas à sua área de interesse.** **O sistema permite que ele visualize conteúdos relevantes com mais rapidez**, reduzindo o esforço de procurar opiniões apenas em conversas presenciais curtas ou em grupos informais.

Ao perceber que precisa aprofundar sua busca, **Lucas utiliza o Goriah para localizar conteúdos relacionados ao tema de seu TCC.** **O sistema apresenta discussões, publicações semelhantes e interações feitas por outros estudantes**, permitindo que ele analise perspectivas diferentes sobre aquele assunto.

**Em seguida, Lucas cria uma publicação na plataforma apresentando sua dúvida ou proposta inicial de tema.** **O sistema registra a publicação e a disponibiliza no feed**, permitindo que outras pessoas a visualizem e interajam.

Conforme novos comentários aparecem, **Lucas acompanha as respostas diretamente na publicação** e utiliza essas contribuições para amadurecer melhor sua decisão. **A plataforma permite que ele concentre, em um mesmo ambiente, opiniões, sugestões e trocas de conhecimento que antes estavam limitadas ao seu círculo imediato.**
